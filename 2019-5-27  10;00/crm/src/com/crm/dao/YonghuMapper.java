...
public interface YonghuMapper {
	 ...
	 * @return
	 */
	Integer updateYonghuqiandaoByyijianqiantui(Yonghu yonghu);
	/**
	 * 判定条件添加过得用户名字不能进行添加
	 */
	Integer selectYonghuByY_nameCount(Yonghu yonghu);
	/**
	 * 判定删除条件 存在用户角色 关系的不能删除
	 */
	Integer selectYonghurolesByY_idCount(Yonghu yonghu);
}
