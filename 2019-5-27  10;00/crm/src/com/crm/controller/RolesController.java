...
//	删除用户角色信息  
	...
	public Integer deleteRoles(Roles roles) { 
		Integer selectModelRolesByR_id = rolesService.selectModelRolesByR_id(roles);
		Integer selectYonghuRolesByR_id = rolesService.selectYonghuRolesByR_id(roles);
		if(selectModelRolesByR_id >0 || selectYonghuRolesByR_id >0) {
			return 0;
		}else {
