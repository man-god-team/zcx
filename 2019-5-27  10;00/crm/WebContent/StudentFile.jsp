...
<!DOCTYPE html>
 ...
 <%Integer i=(Integer)session.getAttribute("rolesInt"); %>
 <%Yonghu yonghu=(Yonghu)session.getAttribute("yonghu"); %>
 
<html>
<head>
<meta charset="UTF-8">
<title>网络学生管理中心</title>
...
<script type="text/javascript" src="js/JSPjs/StudentFile.js"></script>
...
<tr>
	 ...
	 <table id="showBook" class="easyui-datagrid" closed="false">
		<thead>
			<tr>
				...
				<th data-options="field:'y_name',title:'网络咨询师名字'"></th> 
				<!-- <th data-options="field:'w_id',title:'咨询师id'"></th> -->
				...
				<th data-options="field:'y_id',title:'咨询师编号id'"></th>
	...
	<div id="tb">
       ...
       <% if(i >0){ %> 
	        <label for="name">网络咨询师姓名:</label>   
	        <input class="easyui-validatebox" type="text"  id="y_name" data-options="required:false" /> 
	           <input style="display: none;" class="easyui-validatebox" type="text"  id="stu_wid" value=""/>   
	          
       <%  }else{%>
         <input style="display: none;" class="easyui-validatebox" type="text"  id="stu_wid" value="${yonghu.getY_id() }"/>  
         <%} %> 
	...
	buttons:[{
		...
		<form class="easyui-form" id="addfrm">
			...
			<!-- <input class="easyui-textbox" type="text" name="stu_sourcer" id="addstu_sourcer1" style="width: 150px;" />  -->
			  <select id="addstu_sourcer" class="easyui-combobox" name="liyou" style="width: 150px;">
				<option value="">---请选择---</option>
				<option value="未知">未知</option>
		    ...
		    <select id="addstu_site" class="easyui-combobox" name="stu_site" style="width: 150px;">
				<option value="">---请选择---</option>
			...
			<div  style="display: none;" >
				...
				<input class="easyui-textbox" type="text" name="liyou" id="addw_id" value="${yonghu.getY_id() }" style="width: 150px;" />
			</div>
