...
<script type="text/javascript">
	...
	function updateStu(index){
		...
		var data = $("#show").datagrid("getSelected"); 
		
		//打开弹窗
		$("#update-dialog").dialog("open")
		//填充表单
		$("#updatefrm").form("load",data);
	...
	function CK(index){
			...
			//打开弹窗
			$("#update-dialogCK").dialog("open")
			//填充表单
			$("#updatefrmCK").form("load",data);
	...
	function saveUpdate(){
		...
		$.post("updateA",{
			...
			p_firstReturnTime:$("#p_firstReturnTimeA").datetimebox('getValue'),
			...
			p_classTime:$("#p_classTimeA").datetimebox('getValue'),
			p_classNote:$("#p_classNoteA").val(),
			p_whyRefund:$("#p_whyRefundA").val(),
			p_deposit:$("#p_depositA").val(),
			p_depositTime:$("#p_depositTimeA").datetimebox('getValue'),
...
<body>
	...
	<div id="tb">
		<form id="ss">
			...
			<a id="daoru1" href="javascript:void(0)" onclick="CK()" class="easyui-linkbutton" data-options="iconCls:'icon-search'">查看</a> 			
	...
	buttons:[{
		...
		<form class="easyui-form" id="updatefrm">
	        ...
	        <input class="easyui-validatebox" type="text" name="y_id"  id="y_idA"  />  <br>	    <br>	 	 
	        <label for="name">课程方向:</label>   
	        <input class="easyui-validatebox" type="text" name="p_class"  id="p_classA"  /> 
	         &ensp;&ensp;
	    	<label for="name">是否有效:</label>   
	        <input class="easyui-validatebox" type="text" name="p_validity"  id="p_validityA"  /> <br>  <br>	
	        <label for="name">无效原因:</label>   
	        <input class="easyui-validatebox" type="text" name="p_whyValidity"  id="p_whyValidityA"  />
	         &ensp;&ensp;
	         &ensp;<label for="name">打分:</label>     &ensp;&ensp; 
	        <input class="easyui-validatebox" type="text" name="p_score"  id="p_scoreA"  /><br> <br>	
	        <label for="name">是否回访:</label>   
	        <input class="easyui-validatebox" type="text" name="p_isReturn"  id="p_isReturnA"  /><br> <br>	
	        <label for="name">首次回访时间:</label>   
	        <input class="easyui-datebox" type="text" name="p_firstReturnTime"  id="p_firstReturnTimeA"  /><br> <br>	
	        <label for="name">是否上门:</label>   
	        <input class="easyui-validatebox" type="text" name="p_isTheDoor"  id="p_isTheDoorA"  />
	         &ensp;&ensp;
	        <label for="name">上门时间:</label>   
	        <input class="easyui-validatebox" type="text" name="p_timeTheDoor"  id="p_timeTheDoorA"  /><br> <br>	
	        <label for="name">是否缴费:</label>   
	        <input class="easyui-validatebox" type="text" name="p_isPay"  id="p_isPayA"  />
	         &ensp;&ensp;
	        <label for="name">缴费时间:</label>   
	        <input class="easyui-datebox" type="text" name="p_payTime"  id="p_payTimeA"  /><br> <br>	
	       &ensp;<label for="name">金额:</label>     &ensp;&ensp;  
	        <input class="easyui-validatebox" type="text" name="p_price"  id="p_priceA"  />
	         &ensp;&ensp;
	        <label for="name">是否退费:</label>   
	        <input class="easyui-validatebox" type="text" name="p_isRefund"  id="p_isRefundA"  /><br> <br>	
	        <label for="name">是否进班:</label>   
	        <input class="easyui-validatebox" type="text" name="p_isClass"  id="p_isClassA"  />
	         &ensp;&ensp;
	        <label for="name">进班时间:</label>   
	        <input class="easyui-datebox" type="text" name="p_classTime"  id="p_classTimeA"  /><br> <br>	
	        <label for="name">进班备注:</label>   
	        <input class="easyui-validatebox" type="text" name="p_classNote"  id="p_classNoteA"  />
	         &ensp;&ensp;
	        <label for="name">退费原因:</label>   
	        <input class="easyui-validatebox" type="text" name="p_whyRefund"  id="p_whyRefundA"  /><br> <br>	
	        <label for="name">定金金额:</label>   
	        <input class="easyui-validatebox" type="text" name="p_deposit"  id="p_depositA"  />
	         &ensp;&ensp;
	        <label for="name">定金时间:</label>   
	        <input class="easyui-datebox" type="text" name="p_depositTime"  id="p_depositTimeA"  /><br> <br>	
	        <label for="name">咨询师备注:</label>   
	        <input class="easyui-validatebox" type="text" name="rouleNote"  id="rouleNoteA"  /><br> <br>	
	...
	buttons:[{
		...
		<form class="easyui-form" id="addfrm">
			...
			<label for="name">学生id:</label>&nbsp; &nbsp;&nbsp;  <input class="easyui-textbox"
				type="text"  id="stu_idA" name="stu_id" disabled="disabled"
				 style="width: 150px;"/>   &nbsp; &nbsp; &nbsp; &nbsp; 
			<label for="name">用户id:</label> <input class="easyui-textbox"
				type="text"  id="y_idA" value="${yonghu.getY_id() }"
		...
		<div id="update-dialogCK" class="easyui-dialog" data-options="modal:true,closed:true,title:'修改'">
		<form class="easyui-form" id="updatefrmCK">
			
			<label for="name">所在地区:</label>   
	        <input class="easyui-validatebox" type="text" name="stu_Address" disabled="disabled" stu_AddressA" />
	        &ensp;&ensp;
	        <label for="name">咨询师id:</label>   
	        <input class="easyui-validatebox" type="text" name="y_id"  id="y_idA" disabled="disabled" />  <br>	    <br>	 	 
	        <label for="name">课程方向:</label>   
	        <input class="easyui-validatebox" type="text" name="p_class"  id="p_classA" disabled="disabled" /> 
	         &ensp;&ensp;
	    	<label for="name">是否有效:</label>   
	        <input class="easyui-validatebox" type="text" name="p_validity"  id="p_validityA" disabled="disabled" /> <br>  <br>	
	        <label for="name">无效原因:</label>   
	        <input class="easyui-validatebox" type="text" name="p_whyValidity"  id="p_whyValidityA" disabled="disabled" />
	         &ensp;&ensp;
	         &ensp;<label for="name">打分:</label>     &ensp;&ensp; 
	        <input class="easyui-validatebox" type="text" name="p_score"  id="p_scoreA" disabled="disabled" /><br> <br>	
	        <label for="name">是否回访:</label>   
	        <input class="easyui-validatebox" type="text" name="p_isReturn"  id="p_isReturnA" disabled="disabled" /><br> <br>	
	        <label for="name">首次回访时间:</label>   
	        <input class="easyui-validatebox" type="text" name="p_firstReturnTime"  id="p_firstReturnTimeA"disabled="disabled"  /><br> <br>	
	        <label for="name">是否上门:</label>   
	        <input class="easyui-validatebox" type="text" name="p_isTheDoor"  id="p_isTheDoorA" disabled="disabled" />
	         &ensp;&ensp;
	        <label for="name">上门时间:</label>   
	        <input class="easyui-validatebox" type="text" name="p_timeTheDoor"  id="p_timeTheDoorA" disabled="disabled" /><br> <br>	
	        <label for="name">是否缴费:</label>   
	        <input class="easyui-validatebox" type="text" name="p_isPay"  id="p_isPayA" disabled="disabled" />
	         &ensp;&ensp;
	        <label for="name">缴费时间:</label>   
	        <input class="easyui-validatebox" type="text" name="p_payTime"  id="p_payTimeA" disabled="disabled" /><br> <br>	
	       &ensp;<label for="name">金额:</label>     &ensp;&ensp;  
	        <input class="easyui-validatebox" type="text" name="p_price"  id="p_priceA"  disabled="disabled"/>
	         &ensp;&ensp;
	        <label for="name">是否退费:</label>   
	        <input class="easyui-validatebox" type="text" name="p_isRefund"  id="p_isRefundA" disabled="disabled" /><br> <br>	
	        <label for="name">是否进班:</label>   
	        <input class="easyui-validatebox" type="text" name="p_isClass"  id="p_isClassA" disabled="disabled"  />
	         &ensp;&ensp;
	        <label for="name">进班时间:</label>   
	        <input class="easyui-validatebox" type="text" name="p_classTime"  id="p_classTimeA" disabled="disabled" /><br> <br>	
	        <label for="name">进班备注:</label>   
	        <input class="easyui-validatebox" type="text" name="p_classNote"  id="p_classNoteA" disabled="disabled" />
	         &ensp;&ensp;
	        <label for="name">退费原因:</label>   
	        <input class="easyui-validatebox" type="text" name="p_whyRefund"  id="p_whyRefundA" disabled="disabled" /><br> <br>	
	        <label for="name">定金金额:</label>   
	        <input class="easyui-validatebox" type="text" name="p_deposit"  id="p_depositA" disabled="disabled" />
	         &ensp;&ensp;
	        <label for="name">定金时间:</label>   
	        <input class="easyui-validatebox" type="text" name="p_depositTime"  id="p_depositTimeA" disabled="disabled" /><br> <br>	
	        <label for="name">咨询师备注:</label>   
	        <input class="easyui-validatebox" type="text" name="rouleNote"  id="rouleNoteA"  disabled="disabled"/><br> <br>	
	       <!--  <label for="name">Birthday:</label>   
	        <input class="easyui-validatebox" type="text" name="stu_loadTime"  id="stu_loadTimeA" disabled="disabled" />  -->
